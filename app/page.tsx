...
// Компонент Таймера (встроен прямо сюда для простоты)
function Countdown() {
      ...
      <nav className="sticky top-0 z-50 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 p-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <button className="hidden md:block text-sm font-bold text-slate-400 hover:text-white uppercase tracking-wider">Yangiliklar</button>
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <section className="grid md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-[32px] group hover:bg-slate-900 transition-colors">
            ...
            <h3 className="text-2xl font-black mb-3 italic uppercase tracking-tighter">So'nggi xabar</h3>
            <p className="text-slate-500 leading-relaxed font-medium">
              Srečko Katanec: "Meksikadagi iqlimga moslashish uchun bizda maxsus reja bor. 
              Yigitlar ruhan va jismonan tayyor."
            </p>
          </div>
        </section>
      </main>
